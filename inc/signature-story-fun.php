...
return '<div class="element left element-content define-element"><span><img src="'. get_template_directory_uri() . '/assets/img/definition.jpg" alt="definition"></span>' . $atts['definition'] . '</span><span class="define_term"><a>' . $content . '</a></div>';
};
