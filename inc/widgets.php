				...
				<?php if ( !is_front_page() ) { ?>
					...
					<li class="newsletter">
						<a href="/news/college-newsletter/" title="Subscribe to our email newsletter">
							<svg width="30" height="30" viewBox="0 0 34 34" style="display: inline-table; ">
			...
			<?php if (get_option('facebook')) { ?>
					<li class="facebook">
						<a href="<?php echo get_option('facebook'); ?>" title="Follow <?php bloginfo('name'); ?> on Facebook" target="_blank" rel="nofollow" class="external">
							<svg width="30" height="30" viewBox="0 2 37 34" style="display: inline-table; ">
			...
			<?php } ?>					
					<li class="bluesky">
						<a href="https://bsky.app/profile/uwenvironment.bsky.social" title="Follow <?php bloginfo('name'); ?> on Bluesky" target="_blank" rel="nofollow" class="external">
							<svg width="30" height="30" viewBox="0 0 34 34" style="display: inline-table; "><g transform="scale(0.055 0.055)">
