        ...
        <?php if(!empty($title)) { ?>
			...
			<ul>
				...
				<?php if (get_option('linkedin')) { ?>
					...
					<li class="linkedin"><a href="<?php echo get_option('linkedin'); ?>" title="Follow <?php bloginfo('name'); ?> on LinkedIn" target="_blank" rel="nofollow" class="external"><svg width="30" height="30" viewBox="0 0 34 34" style="display: inline-table; fill: #000; margin-bottom: -6px; width: 100%;"><g transform="scale(0.03125 0.03125)"><path d="M928 0h-832c-52.8 0-96 43.2-96 96v832c0 52.8 43.2 96 96 96h832c52.8 0 96-43.2 96-96v-832c0-52.8-43.2-96-96-96zM384 832h-128v-448h128v448zM320 320c-35.4 0-64-28.6-64-64s28.6-64 64-64c35.4 0 64 28.6 64 64s-28.6 64-64 64zM832 832h-128v-256c0-35.4-28.6-64-64-64s-64 28.6-64 64v256h-128v-448h128v79.4c26.4-36.2 66.8-79.4 112-79.4 79.6 0 144 71.6 144 160v288z"></path></g></svg>LinkedIn</a></li>
					<?php } ?>
