...
function taxonomy_major_minor() {

	$labels = array(
		'name'                       => _x( 'Majors and Minors', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Major or Minor', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Majors and Minors', 'text_domain' ),
		'all_items'                  => __( 'All Majors and Minors', 'text_domain' ),
		'parent_item'                => __( 'Parent Major or Minor', 'text_domain' ),
		'parent_item_colon'          => __( 'Parent Major or Minor:', 'text_domain' ),
		'new_item_name'              => __( 'New Major or Minor Name', 'text_domain' ),
		'add_new_item'               => __( 'Add New Major or Minor', 'text_domain' ),
		'edit_item'                  => __( 'Edit Major or Minor', 'text_domain' ),
		'update_item'                => __( 'Update Major or Minor', 'text_domain' ),
		'separate_items_with_commas' => __( 'Separate Majors and Minors with commas', 'text_domain' ),
		'search_items'               => __( 'Search Majors and Minors', 'text_domain' ),
		'add_or_remove_items'        => __( 'Add or remove Majors and Minors', 'text_domain' ),
		'choose_from_most_used'      => __( 'Choose from the most used Majors and Minors', 'text_domain' ),
	...
	register_taxonomy( 'major_minor', array( 'student_ambassadors' ), $args );

}
add_action( 'init', 'taxonomy_major_minor', 0 );
