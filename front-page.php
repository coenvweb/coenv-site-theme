        ...
        <?php if ( $post_sort->have_posts() ) : ?>
            <section class="widget featured-stories">
                ...
                <header>
                    ...
                    <h1><span><a href="<?php echo get_permalink( get_option('page_for_posts') ) ?>page/<?=$page?>/">News from the College</a></span> <a href="<?php echo get_permalink( get_option('page_for_posts') ) ?>page/<?=$page?>/">More &raquo;</a></h1>
                </header>
