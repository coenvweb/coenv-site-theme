		...
		<div class="container">
				...
				<section class="article error">
					...
					<div class="entry-content">
                        ...
                        <p>If you reached this page from clicking on a hyperlink, please contact <a href="mailto:<?=antispambot("coenvweb@uw.edu?subject=404 on environment.uw.edu")?>"><?php echo antispambot("coenvweb@uw.edu"); ?></a> and let us know what page or link you clicked on to get here.</p>
