         ...
         <div class="feature homepage-hero-module">
                ...
                <div class="filter"></div>
                    <?php
                        ...
                        //echo '<source src="' . get_bloginfo('template_directory') . '/assets/video/mekong-video-720.mp4" type="video/mp4" />Your browser does not support the video tag. I suggest you upgrade your browser.';
