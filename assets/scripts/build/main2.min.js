...
e("html").addClass("smooth-scroll"),autoplay=!0;var t=e(".play-pause-hero"),i=e(".poster"),n=e("#hero-video");t.html('<i class="fi-pause">▐▐</i>'),n.removeClass("fullfade"),window.matchMedia("(prefers-reduced-motion)").matches&&(n.removeAttribute("autoplay"),n.get(0).pause(),n.addClass("fade"),console.log(i),i.removeClass("poster-hidden"),t.html('<i class="fi-play"> ►</i>'),autoplay=!1),t.click(function(){n.toggleClass("fade"),n.get(0).pause(),null==autoplay||autoplay===!1?(e(this).html('<i class="fi-pause">▐▐</i>'),n.get(0).play(),autoplay=!0,t.html('<i class="fi-pause">▐▐</i>'),e(".poster").addClass("poster-hidden"),setTimeout(function(){n.get(0).pause(),n.addClass("fade"),t.html('<i class="fi-play"> ►</i>'),autoplay=!1,e(".poster").removeClass("poster-hidden")},12e4)):(e(this).html('<i class="fi-play"> ►</i>'),n.get(0).pause(),autoplay=!1,e(".poster").removeClass("poster-hidden"))}),e(t).keypress(function(i){13==i.which&&e(t).click()}),setTimeout(function(){n.get(0).pause(),n.addClass("fade"),t.html('<i class="fi-play"> ►</i>'),e(".poster").removeClass("poster-hidden"),autoplay=!1},12e4)}}),jQuery(document).ready(function(e){function t(){if(e("#uwalert-alert-message").is(":hidden")){if(e("#uwalert-alert-message")){e("#uwalert-alert-header").append('<div class="button right" id="closer">X</div>');var i=e("#uwalert-alert-header")[0];e("#closer").on("click",function(t){e("#uwalert-alert-message").removeClass("please-unhide"),e("#uwalert-alert-message").hide(),localStorage.clicked=i.innerHTML}),localStorage.clicked===i.innerHTML?(console.log("UW Alert is hidden "+localStorage.clicked),e("#uwalert-alert-message").hide()):e("#uwalert-alert-message").addClass("please-unhide")}}else setTimeout(t,50)}t();var i,n,o,r;e(".article__content .read-more .button").on("click",function(){return r=0,i=e(this),$p=i.parent(),o=$p.parent(),n=o.find("p:not('.read-more')"),$e=o.find(".external"),n.each(function(){r+=e(this).outerHeight(!0)}),r+=$e.outerHeight(!0)+10,o.animate({"max-height":9999}),$p.fadeOut(),!1})}),jQuery(function(e){"use strict";if(!e("body").hasClass("lt-ie8")){if(e("input, textarea").placeholder(),e("article").fitVids(),e(".Faculty-member-tab-nav").memberTabs(),e(".banner-wrapper").bannerReveals(),e(".share").coenvshare(),e("a:not([href*=youtube]):not([href*=youtu]):not([href*=vimeo])").nivoLightbox(),e("figure a img").each(function(){var t=e(this),i=e(this).closest("figure").attr("title");t.parent().attr("title",i)}),e("div.gallery img").each(function(){var t=e(this);t.parent().attr("title",t.attr("alt"))}),e("div.gallery a").each(function(){var t=e(this);t.attr("data-lightbox-gallery",t.closest("div").attr("id"))}),e("body").hasClass("post-type-archive-faculty")&&(e(".js .faculty-toolbox-roller-items").mCustomScrollbar({autoHideScrollbar:!1,setHeight:175,theme:"minimal-dark",scrollInteria:1}),e(".js .faculty-toolbox-roller-items").mCustomScrollbar("scrollTo",".Faculty-toolbox-roller-item--active")),e("body").hasClass("home")){var t=e(".story-thung");t.hide(),e(".stories-container").imagesLoaded(function(){setTimeout(function(){t.fadeIn(),e(".stories-container").masonry({itemSelector:".story",columnWidth:".story-sizer",percentPosition:!0})},200)})}e(".Faculty-member-contact-list").click(function(e){e.stopPropagation()})}}),jQuery("document").ready(function(e){var t=e("#careers-filter");e(window).scroll(function(){e(this).scrollTop()>355?t.addClass("f-nav"):t.removeClass("f-nav"),footertotop=e("#footer").position().top,scrolltop=e(document).scrollTop()+850,difference=scrolltop-footertotop,scrolltop>footertotop?t.css("margin-top",0-difference):t.css("margin-top",0)})});