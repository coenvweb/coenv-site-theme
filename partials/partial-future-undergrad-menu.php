<nav id="arrow-nav" class="second-nav">
    ...
    <ul id="menu-secondary" class="arrow-menu">
        <li class="arrow-button arrow-1 <?php if ((get_the_title() == 'Prepare') || (get_the_title() == 'Opportunties for Early Explorers')) { echo ' active';};?>"><a href="/students/future-students/future-undergrads/prepare/">Prepare</a></li>
        ...
        <li class="arrow-button arrow-3 <?php if (get_the_title() == 'Apply') { echo ' active';};?>"><a href="/students/future-students/future-undergrads/apply/">Apply</a></li>
    </ul>
