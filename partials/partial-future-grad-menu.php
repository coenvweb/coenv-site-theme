<nav id="arrow-nav" class="second-nav">
    ...
    <ul id="menu-secondary" class="arrow-menu">
        <li class="arrow-button arrow-1 <?php if ((get_the_title() == 'Prepare') || (get_the_title() == 'Future Student Opportunities')) { echo ' active';};?>"><a href="/students/future-students/future-graduate-students/prepare/">Prepare</a></li>
        <li class="arrow-button arrow-2 <?php if (get_the_title() == 'Connect') { echo ' active';};?>"><a href="/students/future-graduate-students/future-undergrads/connect/">Connect</a></li>
