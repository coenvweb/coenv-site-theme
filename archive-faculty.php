...
<div class="container">
		 <div class="print">
			<h1>Faculty</h1>
				<p>The College of the Environment Faculty Profiles can be viewed on your computer or mobile device on the web at the <a href="http://www.coenv.washington.edu/faculty" name="Faculty Profiles">College of the Environment website</a>.</p>
